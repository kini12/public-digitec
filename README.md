...
This script is not functional during Black Friday, Cyber Monday, or period of time when more than one product are offered with a discount and referenced on the main page of the website.
...
The data_read.ipynb allows to read data from the Digitec.csv file. From there, you can export the data into output.csv file after correcting the errors.
